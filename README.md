...
<p align="center">
  <img src="logo.png" alt="ClassVoice Logo" width="">
</p>
...
<p align="center">
  <img src="UI.png" alt="ClassVoice Logo" width="">
</p>
...
如果是 NVIDIA GPU，建议安装 CUDA 版 PyTorch：
...
模型权重体积较大，不包含在 Git 仓库中。请在本地自行下载。
...
如果你想使用其他 Vosk 中文模型，把模型目录填到页面侧边栏的 “Vosk 模型目录” 即可。
...
- Qwen3-0.6B 首次加载会占用一定显存/内存；CPU 也能跑，但生成较慢。
